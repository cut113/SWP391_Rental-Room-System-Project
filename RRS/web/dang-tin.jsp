...
=======
>>>>>>> 6f7c866b75352235b8287325a40a034a74dbb020
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
                                		...
                                		<div class="form-group">
                                    		<div class="row">
		                                        <div class="col-sm-6 col-xs-12">
		                                            ...
		                                            <form:input value="${sessionScope.userInfo.fullName}" class="form-control text-box single-line" path="lienHe"/>
		                                        </div>
		                                        <div class="col-sm-6 col-xs-12">
		                                            <label class="control-label">Điện thoại <span class="red_require">*</span></label>
		                                            <form:errors style="color: red" path= "sdt"/>
													<form:input value="${sessionScope.userInfo.sdt}" class="form-control text-box single-line" path="sdt" disabled="true"/>                                            
												</div>
                                    		</div>
                                		</div>
                            		</div>
...
<jsp:include page="footer.jsp"></jsp:include>
    ...
    <script>$(function () { $('#pop-login').modal('show'); }); $('#btnPostCreate').attr('disabled', true)</script>
    <script>
        $(function () {
            $("#ddlUnit").val(2);
=======
                                        ...
                                        <div class="group_fields">
                                            ...
                                            <div class="group_fields_body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label class="control-label">Tiêu đề tin <span class="red_require">*</span></label>
                                                            <errors style="color: red" path= "tieuDe"/>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-6 col-xs-12">
                                                            <label class="control-label">Chuyên mục <span class="red_require">*</span></label>
                                                            <errors style="color: red" path= "loai"/>
                                                            <select path="loai" class="form-control" name="type">
                                                                <option value="" label="--Chọn loại tin--"/>
                                                                <options items="${sessionScope.listType}"/>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6 col-xs-12">
                                                        <label class="control-label">Diện tích <span class="red_require">*</span></label>
                                                        <errors style="color: red" path= "dienTich"/>
                                                        <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="clearfix">
                                                            <div class="pull-left"><label class="control-label">Giá cho thuê <span class="red_require">*</span></label></div>
                                                            <errors style="color: red" path= "giaThue"/>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-6 col-xs-12">
                                                        <label class="control-label">Tỉnh/Thành <span class="red_require">*</span></label>
                                                        <select path="" class="form-control">
                                                            <option value="" label="--Chọn thành Phố--"/>
                                                            <options items="${sessionScope.listTP}" itemValue="MaTP" itemLabel="TenTP"/>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6 col-xs-12">
                                                        <label class="control-label">Quận/Huyện <span class="red_require">*</span></label>
                                                        <select path="" class="form-control">
                                                            ...
                                                            <options items="${sessionScope.listQ}" itemValue="MaQuan" itemLabel="TenQuan"/>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-6 col-xs-12">
                                                        <label class="control-label">Đường/Phố</label>
                                                        <errors style="color: red" path= "maDuong.maDuong"/>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Địa chỉ <span class="red_require">*</span></label>
                                                <errors style="color: red" path= "diaChi"/>
                                        ...
                                        <div class="group_fields_body">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label class="control-label">Nội dung <span class="red_require">*</span></label>
                                                        <errors style="color: red" path= "ghiChu"/>
                                                        <textarea class="form-control edtior-noidung" cols="20" rows="8" path="ghiChu"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="group_fields_body">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-6 col-xs-12">
                                                        <label class="control-label">Tên liên hệ <span class="red_require">*</span></label>
                                                        <errors style="color: red" path= "lienHe"/>
                                                    ...
                                                    <div class="col-sm-6 col-xs-12">
                                                        ...
                                                        <input value="${sessionScope.userInfo.sdt}" class="form-control text-box single-line" path="sdt" disabled="true"/>                                            
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
